        ...
        <div className="mx-5 my-3 bg-slate-50 rounded-xl border border-slate-200/60 overflow-hidden">
          ...
          <div className="px-5 py-3 border-b border-slate-200/60 flex items-center justify-between">
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-[10px] bg-[#2563EB] text-white flex items-center justify-center font-bold text-[10px] flex-shrink-0">
    ...
    return (
      <div className="max-w-[1100px] mx-auto">
        <button
          ...
          className="flex items-center text-xs font-semibold text-slate-500 hover:text-[#2563EB] transition-colors mb-6"
        >
    ...
    <div className="max-w-[1100px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center min-w-0">
          <button
            onClick={() => navigate('/reports')}
            className="flex items-center text-xs font-semibold text-slate-500 hover:text-[#2563EB] transition-colors mr-4 flex-shrink-0"
          >
            <FiArrowLeft className="w-3.5 h-3.5 mr-1.5" /> Back to Reports
          </button>
        ...
        <button
          ...
          className="bg-[#2563EB] text-white px-4 py-2 rounded-lg font-semibold text-xs hover:bg-[#1d4ed8] transition-all flex items-center shadow-sm flex-shrink-0"
        >
      ...
      <div className="bg-white rounded-xl border border-slate-200/70 shadow-sm p-6 mb-6">
        ...
        <div className="w-full h-10 rounded-lg bg-slate-100 overflow-hidden flex">
          {effectiveTotal > 0 ? (
            <>
              {completedPct > 0 && (
                <div
                  className="h-full bg-[#2563EB] flex items-center justify-center text-white text-[11px] font-bold transition-all duration-500 rounded-l-lg"
        ...
        <div className="flex items-center space-x-5 mt-3">
          <div className="flex items-center">
            <span className="w-2.5 h-2.5 rounded-sm bg-[#2563EB] mr-1.5" />
                ...
                <React.Fragment key={c.mailId}>
                  ...
                  >
                    <td className="px-5 py-4 w-8">
                      {isExpanded
                        ? <FiChevronUp className="w-3.5 h-3.5 text-[#2563EB]" />
                        : <FiChevronDown className="w-3.5 h-3.5 text-slate-400 group-hover:text-slate-600" />}
                    </td>
                    <td className="px-5 py-4">
                      <div className="flex items-center">
                        <div className="w-7 h-7 rounded-lg bg-blue-50 text-[#2563EB] flex items-center justify-center mr-2.5 flex-shrink-0">
                          <FiMail className="w-3 h-3" />
                        </div>
                        <div className="min-w-0">
                          <p className="font-semibold text-slate-800 text-xs truncate group-hover:text-[#2563EB] transition-colors">
